...
#Image of the fastest growing species (replace 'your_image.png' with the actual filename)
```{r}
knitr::include_graphics("/Users/OliviaGilpin/Desktop/ESS330/img/Thuja_occidentalis.png")
```
![Thuja occidentalis - fastest growing species](img/Thuja_occidentalis.png)
